  ...
  return (
    <div className="min-h-screen overflow-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] gradient-glow rounded-full blur-3xl opacity-40" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] gradient-glow rounded-full blur-3xl opacity-30" />
        <div className="absolute top-1/2 right-1/3 w-[300px] h-[300px] gradient-glow rounded-full blur-3xl opacity-20" />
      </div>

      {/* Glassmorphism Navbar */}
      <nav className="glass-navbar fixed top-0 left-0 right-0 z-50 px-4 py-4 lg:px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-primary/20 border border-primary/30 flex items-center justify-center glow-button">
      ...
      {/* Hero Section */}
      <section className="relative z-10 px-4 pt-28 pb-20 lg:pt-40 lg:pb-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-foreground mb-8 leading-tight animate-slide-up tracking-tight">
            Your Journey to{' '}
